...
<nav class="light-red  lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">古韵课堂</a>
        <ul class="right hide-on-med-and-down">
            <li><a href="/ThinkPHP_study/index.php">主页</a></li>
            <li><a href="/ThinkPHP_study/index.php/Home/Dictionary">字典</a></li>
            <li><a href="badges.html">Components</a></li>
            <li><a href="badges.html">新闻</a></li>
            <li class="active"><a href="/ThinkPHP_study/index.php/Home/About">关于</a></li>
        </ul>
        <!--<ul class="right hide-on-med-and-down">-->
